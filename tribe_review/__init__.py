...
* :mod:`tribe_review.copy_es` — Spanish (México) copy strings + small label
  helpers. Renamed from ``copy_ru`` in Stage-3 / S1.
...
from tribe_review.copy_es import ACTION_VARIANTS
