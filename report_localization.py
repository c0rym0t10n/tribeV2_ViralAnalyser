...
UI_TEXTS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "hero_curve_title": "Lee la curva",
        "hero_curve_desc": "Mira dónde el video gana, aguanta y pierde la atención.",
        "hero_curve_note": "El timeline es tu control principal: pasa el cursor, compara los bajones y revisa los shots de al lado.",
        "hero_brain_title": "Entiende el frame",
        "hero_brain_desc": "La brain map convierte el modelo en una explicación visual.",
        "hero_brain_note": "Las zonas grandes se quedan a la vista, y las barras de abajo muestran qué sistema pesa más en cada momento.",
        "hero_action_title": "Acciona sobre el cut",
        "hero_action_desc": "Usa la capa práctica para decidir qué cortar, mover o reforzar.",
        "hero_action_note": "Las recomendaciones son pistas de edición, no magia. Compara versiones, muévete rápido y prueba los cambios contra la curva.",
        "upload_explainer": "Sube un video para un review completo o de 2 a 4 videos para comparar versiones. La app los procesa uno por uno.",
        "upload_chip_single": "1 video = review a profundidad",
        "upload_chip_compare": "2–4 videos = comparativa",
        "upload_chip_safe": "se procesan uno por uno",
        "mode_toggle_deep": "A profundidad",
        "mode_toggle_simplified": "Simplificado",
        "running_analysis": "Analizando",
        "running_note": "Los archivos pesados van uno por uno para que la app no se atore.",
        "running_status": "Corriendo análisis TRIBE...",
        "running_wait": "Esto puede tardar",
        "compare_mode": "Modo comparativa",
        "model_disclaimer": "El modelo muestra dónde el video parece mover más o menos al espectador. Está basado en un espectador promedio, no en una persona real. Toma cada timestamp como una zona aproximada de edición y revisa la ventana alrededor.",
        "workspace_tab": "Zona de trabajo",
        "summary_tab": "Resumen",
        "actions_tab": "Qué hacer",
        "details_tab": "Detalles",
        "compare_overlay_note": "Mantén la gráfica overlay a la vista y compara los cuts más fuertes con los más flojos lado a lado.",
        "compare_overlay_title": "Overlay de la respuesta predicha",
        "brain_map_label": "Brain map",
        "compare_score_label": "score de la comparativa",
        "compare_graph_avg": "promedio de la curva",
        "compare_start": "arranque",
        "workflow_note": "El orden más cómodo es: deja el video a la izquierda, lee la curva y la brain map al centro, y usa las barras de zonas a la derecha como capa de explicación en vivo.",
        "workflow_layout_note": "Layout fijo para que la lectura sea estable",
        "video_label": "Video",
        "predicted_response_title": "Respuesta predicha sobre el tiempo",
        "predicted_brain_title": "Mapa de actividad predicha",
        "predicted_brain_note": "Las zonas grandes del cerebro están coloreadas por área, y los hotspots brillantes muestran dónde el momento actual se lee más fuerte.",
        "recommendations_note": "Las recomendaciones de abajo son pistas generales de edición. Lo principal es mirar la curva «Respuesta predicha sobre el tiempo»: ve los bajones, compara qué pasa ahí con los momentos más fuertes, experimenta con ajustes y corre tests comparativos para encontrar la mejor versión.",
        "prediction_details_title": "Detalles del análisis",
        "prediction_duration": "Duración",
        "prediction_seconds_unit": "segundos",
        "prediction_video_size": "Tamaño del video",
        "prediction_fps_unit": "frames por segundo",
        "prediction_parts": "Partes en el análisis",
        "prediction_parts_note": "Es cuántos pedazos usó el modelo para armar la lectura.",
        "prediction_strongest": "Momento más fuerte en la curva",
        "prediction_strongest_note": "Aquí la curva sube más alto que en cualquier otro punto del video.",
        "sources_title": "Fuentes oficiales del modelo",
        "sources_desc": "Materiales publicados por los autores del modelo y la página oficial de release de TRIBE v2.",
        "sources_meta_link": "Publicación de Meta AI",
        "sources_tribe_link": "Página del modelo TRIBE v2",
        "brain_3d_load_error": "El motor 3D no cargó. Refresca la página e intenta de nuevo.",
        "brain_3d_no_webgl": "Este navegador no tiene WebGL, así que la vista 3D del cerebro no se puede renderizar.",
        "brain_zone_higher": "más activa ahorita",
        "brain_zone_active": "activa ahorita",
        "brain_zone_low": "actividad baja",
        "brain_zone_none": "El modelo no está resaltando una sola zona grande del cerebro con suficiente fuerza en este momento.",
    },
    "en": {
        "language": "Language",
        ...
        "hero_curve_title": "Read the curve",
        "hero_curve_desc": "See where attention grows, holds, and falls off.",
        "hero_curve_note": "The timeline is the main control surface: hover, compare dips, and inspect nearby shots.",
        "hero_brain_title": "Understand the frame",
        "hero_brain_desc": "The brain map turns the model into a visual explanation.",
        "hero_brain_note": "Large zones stay visible, while the moving bars show which systems matter more in the current moment.",
        "hero_action_title": "Act on the cut",
        "hero_action_desc": "Use the practical layer to decide what to trim, move, or reinforce.",
        "hero_action_note": "Recommendations are editing hints, not magic. Compare versions, move faster, and test changes against the curve.",
        "upload_explainer": "Upload one video for a single review or 2-4 videos to compare versions. The app processes them one by one.",
        "upload_chip_single": "1 video = deep review",
        "upload_chip_compare": "2–4 videos = comparison",
        "upload_chip_safe": "processed safely in sequence",
        "mode_toggle_deep": "Deep",
        "mode_toggle_simplified": "Simplified",
        "running_analysis": "Running analysis",
        "running_note": "Large files are processed one by one so the app stays stable and predictable.",
        "running_status": "Running TRIBE analysis...",
        "running_wait": "This can take a while",
        "compare_mode": "Compare mode",
        "model_disclaimer": "The model shows where the video seems to affect the viewer more or less strongly. It is based on an average viewer model, not one real person. Treat each timestamp as an approximate editing zone and inspect the nearby window around it.",
        "workspace_tab": "Workspace",
        "summary_tab": "Summary",
        "actions_tab": "Actions",
        "details_tab": "Details",
        "compare_overlay_note": "Keep the overlay graph in view and compare the strongest and weakest cuts side by side.",
        "compare_overlay_title": "Overlaid predicted response",
        "brain_map_label": "Brain map",
        "compare_score_label": "comparison score",
        "compare_graph_avg": "graph avg",
        "compare_start": "start",
        "workflow_note": "The cleanest workflow is: keep the video on the left, read the curve and brain map in the center, then use the zone bars on the right as a live explanation layer.",
        "workflow_layout_note": "Fixed workspace layout for stable reading",
        "video_label": "Video",
        "predicted_response_title": "Predicted response over time",
        "predicted_brain_title": "Predicted brain map",
        "predicted_brain_note": "Large brain zones are tinted by area, and bright hotspots show where the current moment reads stronger.",
        "recommendations_note": "The recommendations below are general editing hints. The main thing to watch is the \"Predicted response over time\" curve: look at the dips, compare what happens there with stronger moments, experiment with edits, and run comparative tests to find the best version.",
        "prediction_details_title": "Prediction details",
        "prediction_duration": "Duration",
        "prediction_seconds_unit": "seconds",
        "prediction_video_size": "Video size",
        "prediction_fps_unit": "frames per second",
        "prediction_parts": "Parts in analysis",
        "prediction_parts_note": "This is how many pieces the model used to build the read.",
        "prediction_strongest": "Strongest moment on the graph",
        "prediction_strongest_note": "Here the curve rises higher than anywhere else in this video.",
        "sources_title": "Official model sources",
        "sources_desc": "Materials published by the model authors and the official TRIBE v2 release page.",
        "sources_meta_link": "Meta AI publication",
        "sources_tribe_link": "TRIBE v2 model page",
        "brain_3d_load_error": "3D engine did not load. Refresh the page and try again.",
        "brain_3d_no_webgl": "WebGL is unavailable in this browser, so the 3D brain view cannot render.",
        "brain_zone_higher": "more active now",
        "brain_zone_active": "active now",
        "brain_zone_low": "low activity",
        "brain_zone_none": "The model does not highlight one large brain zone strongly enough in this moment.",
    },
}
...
METRIC_LABELS = {
    "es": {
        "Arranque de la curva": "Arranque de la curva",
        "Cómo aguanta la curva": "Cómo aguanta la curva",
        "Ritmo del cambio": "Ritmo del cambio",
        "Bajones bruscos": "Bajones bruscos",
        "Fuerza visual": "Fuerza visual",
        "Hook": "Hook",
        "Retention": "Retention",
        "Pacing": "Pacing",
    ...
    "en": {
        "Arranque de la curva": "Curve start",
        "Cómo aguanta la curva": "How the curve holds",
        "Ritmo del cambio": "Pace of new events",
        "Bajones bruscos": "Sharp drops",
        "Fuerza visual": "Average level",
        "Hook": "Hook",
        "Retention": "Retention",
        "Pacing": "Pacing",
        "Visual clarity": "Visual clarity",
...
LABEL_MAP_EN = {
    # Focus-window labels (deep mode emits these via tribe_review.timeline).
    "Tramo fuerte": "Strong section",
    "Bache": "Where to fix first",
    "Cambio brusco": "Where to speed up",
    # Curve-alignment defaults (curve_alignment.py emits these).
    "Dónde arreglar primero": "Where to fix first",
    "Otro bache": "Another drop",
    "Aquí se ve un bache claro en la curva.": "There is a clear dip here on the curve.",
    "Aquí se ve otro bache claro en la curva.": "There is another clear dip on the curve here.",
    "Tómalo de referencia para el resto.": "Use this section as the anchor.",
    "Dejar": "Keep",
    "Hacer primero": "Do first",
    "Hacer después": "Do next",
    # Action-item titles emitted by ollama_sanitize / ollama_concrete (the
    # subset that lives outside ACTION_VARIANTS — those are auto-populated
    ...
    # Speech-side metric labels emitted by tribe_review.timeline /
    # ollama_sanitize when simplified mode runs.
    ...
    # Drop-marker label emitted by curve_alignment seek targets.
    "Momento sospechoso": "Weak spot",
    # Common UI labels surfaced by the report renderers.
    "Lo que jala": "What is working",
    "Lo que no jala": "What is weak",
    "Siguiente paso": "Next step",
    "Lo que estorba": "What is hurting",
    "Voz": "Speech",
}
